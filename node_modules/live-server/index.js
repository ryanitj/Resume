#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\users\\55479\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.235\\out\\buildhook\\index.js').default({tool: 'live-server'}); } catch(cjsError) { try { import('file:///c:/users/55479/.vscode/extensions/wallabyjs.console-ninja-1.0.235/out/buildhook/index.js').then(m => m.default.default({tool: 'live-server'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
